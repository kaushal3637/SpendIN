...
function ChainButtonComponent({
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className={`relative ${compact ? 'p-3' : 'p-3 sm:p-4'} rounded-lg border-2 transition-all duration-200 touch-manipulation ${compact ? 'min-h-[70px]' : 'min-h-[80px]'} sm:min-h-[88px] flex flex-col justify-center ${isSelected
...
export default function ChainButtons({
  ...
  return (
    <div className={`w-full min-h-screen flex flex-col justify-center items-center px-3 sm:px-4 md:px-6 lg:px-8 ${className}`}>
      <div className="w-full max-w-md mx-auto">
        ...
        {showHeader && (
          <div className="mb-4 sm:mb-6 text-center">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-2 bg-gray-50 rounded-full text-xs sm:text-sm mb-4 sm:mb-6">
              {connectedChain ? (
                <>
